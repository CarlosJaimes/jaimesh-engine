...
#[derive(Debug, Parser)]
#[command(bin_name = "jaimesh plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "jaimesh plugin add",
    after_help = "Examples:\n  jaimesh plugin add sample@debug\n  jaimesh plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "jaimesh plugin list",
    after_help = "Examples:\n  jaimesh plugin list\n  jaimesh plugin list --marketplace debug\n  jaimesh plugin list --json\n  jaimesh plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "jaimesh plugin remove",
    after_help = "Examples:\n  jaimesh plugin remove sample@debug\n  jaimesh plugin remove sample --marketplace debug"
)]
