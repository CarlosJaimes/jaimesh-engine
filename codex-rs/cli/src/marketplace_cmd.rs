...
#[derive(Debug, Parser)]
#[command(bin_name = "jaimesh plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "jaimesh plugin marketplace add",
    after_help = "Examples:\n  jaimesh plugin marketplace add ./path/to/marketplace\n  jaimesh plugin marketplace add owner/repo --ref main\n  jaimesh plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "jaimesh plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "jaimesh plugin marketplace upgrade",
    after_help = "Examples:\n  jaimesh plugin marketplace upgrade\n  jaimesh plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "jaimesh plugin marketplace remove",
    after_help = "Example:\n  jaimesh plugin marketplace remove debug"
)]
